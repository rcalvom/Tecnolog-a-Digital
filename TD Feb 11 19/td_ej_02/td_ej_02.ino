...
Button BtnSet(SET_PIN, PULLUP, INVERT, DEBOUNCE_MS);    //Declare the objects usando el constructor: Button(pin, puEnable, invert, dbTime);
Button BtnPulsacion(MIN_PIN, PULLUP, INVERT, DEBOUNCE_MS);    //Declare the objects usando el constructor: Button(pin, puEnable, invert, dbTime);
//------------------------------------------------------------------------------------------------------------------------------------------------
